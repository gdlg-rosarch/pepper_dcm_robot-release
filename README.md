## pepper_dcm_robot (kinetic) - 0.0.5-0

The packages in the `pepper_dcm_robot` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release pepper_dcm_robot --track kinetic --rosdistro kinetic` on `Thu, 16 Nov 2017 15:00:51 -0000`
